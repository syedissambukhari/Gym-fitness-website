...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['color_name'])) {
        $valid = 0;
        $error_message .= "Time Duration can not be empty<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "month already exists<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'months is added successfully.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Month <span>*</span></label>
							<div class="col-sm-4">
